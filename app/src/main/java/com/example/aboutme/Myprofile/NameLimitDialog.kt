...
class NameLimitDialog():DialogFragment(){

    lateinit var binding: FragmentNamelimitDialogBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentNamelimitDialogBinding.inflate(inflater, container, false)
